...
class Tests_Comment extends WP_UnitTestCase {
	...
	public function test_wp_comment_get_children_should_fill_children() {
		...
		$this->assertSameSets( array( $c2, $c4 ), array_values( wp_list_pluck( $children, 'comment_ID' ) ) );

		// Direct descendants of $c2.
		$this->assertSameSets( array( $c3 ), array_values( wp_list_pluck( $children[ $c2 ]->get_children(), 'comment_ID' ) ) );
	}
