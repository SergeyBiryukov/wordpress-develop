...
class Tests_Admin_includesTemplate extends WP_UnitTestCase {
	...
	function test_equal() {
		...
		$this->assertSame( ' selected=\'selected\'', selected( '1', 1, false ) );
		$this->assertSame( ' checked=\'checked\'', checked( '1', 1, false ) );

		$this->assertSame( ' selected=\'selected\'', selected( '1', true, false ) );
		$this->assertSame( ' checked=\'checked\'', checked( '1', true, false ) );
		...
		$this->assertSame( ' selected=\'selected\'', selected( true, true, false ) );
		$this->assertSame( ' checked=\'checked\'', checked( true, true, false ) );

		$this->assertSame( ' selected=\'selected\'', selected( '0', 0, false ) );
		$this->assertSame( ' checked=\'checked\'', checked( '0', 0, false ) );

		$this->assertSame( ' selected=\'selected\'', selected( 0, 0, false ) );
		$this->assertSame( ' checked=\'checked\'', checked( 0, 0, false ) );

		$this->assertSame( ' selected=\'selected\'', selected( '', false, false ) );
		$this->assertSame( ' checked=\'checked\'', checked( '', false, false ) );

		$this->assertSame( ' selected=\'selected\'', selected( false, false, false ) );
		$this->assertSame( ' checked=\'checked\'', checked( false, false, false ) );
	}

	function test_notequal() {
		$this->assertSame( '', selected( '0', '', false ) );
		$this->assertSame( '', checked( '0', '', false ) );

		$this->assertSame( '', selected( 0, '', false ) );
		$this->assertSame( '', checked( 0, '', false ) );

		$this->assertSame( '', selected( 0, false, false ) );
		$this->assertSame( '', checked( 0, false, false ) );
	}
