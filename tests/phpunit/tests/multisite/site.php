...
if ( is_multisite() ) :
	...
	class Tests_Multisite_Site extends WP_UnitTestCase {
		...
		function test_wpmu_update_blogs_date() {
			...
			$this->assertEqualsWithDelta( $current_time, strtotime( $blog->last_updated ), 'The dates should be equal', 2 );
		}
		...
		public function test_site_dates_are_gmt() {
			...
			$site = get_site( $site_id );
			$this->assertEqualsWithDelta( strtotime( $first_date ), strtotime( $site->registered ), 'The dates should be equal', 2 );
			$this->assertEqualsWithDelta( strtotime( $first_date ), strtotime( $site->last_updated ), 'The dates should be equal', 2 );
			...
			$site = get_site( $site_id );
			$this->assertEqualsWithDelta( strtotime( $first_date ), strtotime( $site->registered ), 'The dates should be equal', 2 );
			$this->assertEqualsWithDelta( strtotime( $second_date ), strtotime( $site->last_updated ), 'The dates should be equal', 2 );
		}
