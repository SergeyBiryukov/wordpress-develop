...
class WP_Test_REST_Posts_Controller extends WP_Test_REST_Post_Type_Controller_Testcase {
	...
	public function test_putting_same_publish_date_does_not_remove_floating_date() {
		...
		$this->assertSame( strtotime( $get_body['date'] ), strtotime( $body['date'] ), 'The dates should be equal', 2 );
		$this->assertSame( strtotime( $get_body['date_gmt'] ), strtotime( $body['date_gmt'] ), 'The dates should be equal', 2 );
	...
	public function test_putting_different_publish_date_removes_floating_date() {
		...
		$this->assertSame( strtotime( mysql_to_rfc3339( $new_time ) ), strtotime( $body['date'] ), 'The dates should be equal', 2 );
